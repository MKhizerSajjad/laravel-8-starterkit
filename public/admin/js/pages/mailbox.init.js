    ...
    Array.from(document.querySelectorAll(".message-list li")).forEach(function(c) {
        c.addEventListener("click", function() {
            var e = c.querySelector(".subject-title").innerHTML,
                a = (document.querySelector(".email-subject-title").innerHTML = e, c.querySelector(".title-name").innerHTML),
                t = (Array.from(document.querySelectorAll(".accordion-item.left")).forEach(function(e) {
